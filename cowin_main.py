...
import MySQLdb
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql://o33umr90ei1kamrx:mia1214m3qis0sr2@y5svr1t2r5xudqeq.cbetxkdyhwsb.us-east-1.rds.amazonaws.com:3306/adbsc9v6rvrg31pw'
...
class userlist(db.Model):
    ...
    filler1 = db.Column(db.String(100), nullable=True)
    filler2 = db.Column(db.String(100), nullable=True)
    filler3 = db.Column(db.String(100), nullable=True)
    filler4 = db.Column(db.String(100), nullable=True)
    filler5 = db.Column(db.String(100), nullable=True)
